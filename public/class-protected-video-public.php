...
class Protected_Video_Public
{
  ...
  {
    global $post;
    // Check Protected Video block or Protected Video Shortcode is in use on this page
    if (has_block('protected-video/protected-video', get_the_ID()) || has_shortcode($post->post_content, 'protected_video')) {
